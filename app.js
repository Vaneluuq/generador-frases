...
let X = document.getElementById("app").style.background = colors[random]
}
...
fetch(`${API_URL}`)
 ...
 .then(joke=> {
     console.log(joke)
    HTMLResponse.innerHTML = `<p>${joke.joke}</p>`
 })
}
...
let btnChangerColorFrase= () => {
document.getElementById("app").classList.toggle("mystyle")
}
